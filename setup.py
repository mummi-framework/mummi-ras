...
setup(
    ...
    entry_points={
      'console_scripts': [
          'createsim = mummi_ras.transformations.createsim.createsims:main',
          'cganalysis = mummi_ras.online.cg.cganalysis:main',
          'backmapping = mummi_ras.transformations.backmapping.backmapping:main',
          'aaanalysis = mummi_ras.online.aa.aa_analysis:main',
      ]
    },
